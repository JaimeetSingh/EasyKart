...
import { show_men_items, addToList, addToWishlist,show_filter_menitems,
  show_search_menitems } from "./UserFunctions";
...
class MenItems extends Component {
  ...
  onSubmit = (val, e) => {
    ...
    show_filter_menitems(this.state.min, this.state.max).then(data => {
      this.setState(
        {
          items: [...data]
        },
        () => {
          console.log("this is menItems in getAll: " + this.state.items);
        }
      );
    });
  };
  ...
  onSearch = search => {
    ...
    show_search_menitems(this.state.search).then(data => {
      this.setState(
        {
          items: [...data],
          search: ""
        ...
        () => {
          console.log("this is menItems in getAll: " + this.state.search);
        }
      );
    });
  };
